...
void _ala::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor)
{
    ...
    cubo.draw(modo, r1, g1, b1, grosor); // color1: 0.2 0.2 0.2
    glPopMatrix();
    ...
    cubo.draw(modo, r1, g1, b1, grosor);
    glPopMatrix();
    ...
    aleron.draw(modo, r2, g2, b2, grosor); // color2: 0.1, 0.3, 0.9
    glPopMatrix();
}
...
void _helice::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor)
{
    ...
    eje.draw(modo, r1, g1, b1, grosor); // color1: 0.1, 0.5, 1
    glPopMatrix();
    ...
    glTranslatef(0, 0, longitud_brazo);
        ...
        eje.draw(modo, r1, g1, b1, grosor);
        glPopMatrix();

        glPushMatrix();
        for (unsigned short int i = 0; i < num_helices; i++) {
            glRotatef(360 / num_helices, 0, 0, 1);
            aspa.draw(modo, r2, g2, b2, grosor); // color2: 0.2, 0.2, 1
        }
        glPopMatrix();
    glPopMatrix();
}
...
void _tren_aterrizaje::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor)
{
    ...
    cilindro.draw(modo, r1, g1, b1, grosor); // color1: 0.3 0.3 0.3
    glPopMatrix();
    ...
    cilindro.draw(modo, r2, g2, b2, grosor); // color2: 0.2 0.2 0.2
    glPopMatrix();
}
...
void _fuselaje::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float r3, float g3, float b3, float grosor)
{
    glPushMatrix();
    glScalef(this->anchura, this->altura / 2, this->longitud);
    cubo.draw(modo, r1, g1, b1, grosor); // color 1 : 0.2 0.2 0.2
    glPopMatrix();
    ...
    retrovisor.draw(modo, r2, g2, b2, grosor); // color2: 0, 0.6, 0.9
    glPopMatrix();
    ...
    cubo.draw(modo, r3, g3, b3, grosor); // color3: 0.15, 0.15, 0.15
    glPopMatrix();
}
...
void _avion::draw(_modo modo, float r, float g, float b, float grosor)
{
    ...
    glRotatef(inclinacion_vertical, 1, 0, 0);
        ...
        // Fuselaje
        if (activo[0] == 0)
            fuselaje.draw(modo, 0.2, 0.2, 0.2, 0, 0.6, 0.9, 0.15, 0.15, 0.15, grosor);
        else
            fuselaje.draw(EDGES, color_pick._0, color_pick._1, color_pick._2, color_pick._0, color_pick._1, color_pick._2, color_pick._0, color_pick._1, color_pick._2, grosor_select);
        ...
        if (activo[1] == 0)
            ala.draw(modo, 0.2, 0.2, 0.2, 0.1, 0.3, 0.9, grosor);
        else
            ala.draw(EDGES, color_pick._0, color_pick._1, color_pick._2, color_pick._0, color_pick._1, color_pick._2, grosor_select);
        glPopMatrix();
        ...
        if (activo[5] == 0)
            ...
            timon.draw(EDGES, color_pick._0, color_pick._1, color_pick._2, grosor_select);
        glPopMatrix();
        ...
        if (activo[6] == 0)
            helice.draw(modo, 0.1, 0.5, 1, 0.2, 0.2, 1, grosor);
        else
            helice.draw(EDGES, color_pick._0, color_pick._1, color_pick._2, color_pick._0, color_pick._1, color_pick._2, grosor_select);
        glPopMatrix();
        ...
        if (activo[7] == 0)
            tren_aterrizaje.draw(modo, 0.3, 0.3, 0.3, 0.2, 0.2, 0.2, grosor);
        else
            tren_aterrizaje.draw(EDGES, color_pick._0, color_pick._1, color_pick._2, color_pick._0, color_pick._1, color_pick._2, grosor_select);
        glPopMatrix();
...
void _avion::picking() {
    ...
    fuselaje.draw(PICKING, color.r, color.g, color.b, color.r, color.g, color.b, color.r, color.g, color.b, 1);
    ...
    ala.draw(PICKING, color.r, color.g, color.b, color.r, color.g, color.b, 1);
    glPopMatrix();
    ...
    timon.draw(PICKING, color.r, color.g, color.b, 1);
    glPopMatrix();
    ...
    helice.draw(PICKING, color.r, color.g, color.b, color.r, color.g, color.b, 1);
    glPopMatrix();
    ...
    tren_aterrizaje.draw(PICKING, color.r, color.g, color.b, color.r, color.g, color.b, 1);
    glPopMatrix();
...
void _triangulos3D::draw_picking(_vertex3f color) {
    glPolygonMode(GL_FRONT, GL_FILL);
    glColor3ub(color._0, color._1, color._2);
    glBegin(GL_TRIANGLES);
    for (unsigned i = 0; i < caras.size(); i++)
    {
        glVertex3fv((GLfloat *)&vertices[caras[i]._0]);
